...
export class TasksService {
  ...
  async update(id: string, dto: UpdateTaskDto) {
    ...
    const order = typeof dto.order === 'number' ? dto.order : existing.order
  ...
  async reorder(tasks: { id: string; status: 'todo' | 'done'; order: number }[]) {
    ...
    const ops: Prisma.PrismaPromise<Task>[] = []
