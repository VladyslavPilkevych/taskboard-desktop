import { ApiTask, CreateTaskInput, Task, UpdateTaskInput } from '@/utils/types/types'
...
export async function updateTaskApi(id: string, data: UpdateTaskInput): Promise<Task> {
